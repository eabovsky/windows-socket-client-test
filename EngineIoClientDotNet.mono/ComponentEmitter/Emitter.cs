...
namespace Quobject.EngineIoClientDotNet.ComponentEmitter
{
    ...
    public class Emitter
    {
        ...
        public Emitter On(string eventString, Action<object, object> fn)
        {
            var listener = new ListenerImpl(fn);
            return On(eventString, listener);
        }

        public Emitter On(string eventString, Action<object, object, object> fn)
        {
            var listener = new ListenerImpl(fn);
            return On(eventString, listener);
        }
    ...
    public class ListenerImpl : IListener
    {
        ...
        public ListenerImpl(Action<object, object> fn2)
        {
        ...
        public ListenerImpl(Action<object, object, object> fn3)
        {
